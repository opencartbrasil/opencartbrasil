...
$_['button_remove'] = 'Salvar';
$_['button_add_header'] = 'Add Cabeçalho';

$_['entry_status'] = 'Situação';
$_['entry_description'] = 'Descrição';
$_['entry_url'] = 'URL';
$_['entry_auth'] = 'Autenticação HTTP Basic';
$_['entry_auth_user'] = 'Usuário (HTTP Basic)';
$_['entry_auth_password'] = 'Senha (HTTP Basic)';
$_['entry_headers'] = 'Cabeçalhos';
$_['entry_headers_example'] = 'Ex.: Content-Type: application/json';
